export default {
  ...
  searchInformation: {
    ...
    totalResults: "2210000000",
    formattedTotalResults: "2,210,000,000",
  },
  items: [
    {
      ...
      pagemap: {
        cse_thumbnail: [
          {
            src: "https://encrypted-tbn3.gstatic.com/images?q=tbn:ANd9GcQ47Ea_chJeaK2erZqKmrQlwzQQO8wA63tVIj3Iz1igN3vqFYlLdvuN2Vft",
            width: "220",
            height: "196",
          },
        ],
        ...
        cse_image: [
          {
            src: "https://upload.wikimedia.org/wikipedia/commons/thumb/0/0b/HelloWorld_Maktivism_ComputerProgramming_LEDs.jpg/220px-HelloWorld_Maktivism_ComputerProgramming_LEDs.jpg",
          },
        ],
      },
    },
    ...
    },
    {
      ...
      htmlTitle:
        "Online Gift Shop in Philadelphia |Unique Gift Store - <b>Hello World</b>",
    ...
    },
    {
      ...
      snippet:
        "Hello World. The smallest React example looks like this: const root = ReactDOM.createRoot(document.getElementById('root')); root.render(<h1>Hello, world!",
      htmlSnippet:
        "<b>Hello World</b>. The smallest React example looks like this: const root = ReactDOM.createRoot(document.getElementById(&#39;root&#39;)); root.render(&lt;h1&gt;<b>Hello</b>, <b>world</b>!",
    ...
    },
    {
      ...
      snippet: "Hello World! (an example of minimal Dockerization)",
      htmlSnippet: "<b>Hello World</b>! (an example of minimal Dockerization)",
    ...
    },
    {
      ...
      snippet:
        "Hello World issue 19. Over the last three years, we've seen more than 7 million students around the world put down their schoolwork and take to the streets ...",
      htmlSnippet:
        "<b>Hello World</b> issue 19. Over the last three years, we&#39;ve seen more than 7 million students around the world put down their schoolwork and take to the streets&nbsp;...",
        ...
        metatags: [
          {
            ...
            viewport: "width=device-width, initial-scale=1",
            "csrf-token":
              "nI4Fa+S138i3C37fGGPwmLoVksYYU/1jMfyVw9SqGC5XogL/3OGZFtZXnIilkg4KHELycy13d0tX8JlJThnYzg==",
            "og:locale": "en_GB",
